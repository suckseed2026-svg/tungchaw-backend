...
@ApiTags('Sales')
@ApiBearerAuth()
@ApiHeader({ name: 'X-Business-Id', required: true, description: 'Selected business UUID' })
...
export class SalesController {
  ...
  createDraft(@Param('businessId', ParseUUIDPipe) businessId: string, @CurrentBusiness() business: CurrentBusinessData, @CurrentUser() user: JwtUser, @Body() dto: CreateSaleDraftDto) {
  ...
  updateDraft(@Param('businessId', ParseUUIDPipe) businessId: string, @Param('saleId', ParseUUIDPipe) saleId: string, @CurrentBusiness() business: CurrentBusinessData, @CurrentUser() user: JwtUser, @Body() dto: UpdateSaleDraftDto) {
    this.assertBusiness(businessId, business.id);
  ...
  complete(@Param('businessId', ParseUUIDPipe) businessId: string, @Param('saleId', ParseUUIDPipe) saleId: string, @CurrentBusiness() business: CurrentBusinessData, @CurrentUser() user: JwtUser, @Body() dto: CompleteSaleDto) {
    this.assertBusiness(businessId, business.id);
  ...
  cancel(@Param('businessId', ParseUUIDPipe) businessId: string, @Param('saleId', ParseUUIDPipe) saleId: string, @CurrentBusiness() business: CurrentBusinessData, @CurrentUser() user: JwtUser, @Body() dto: CancelSaleDto) {
    this.assertBusiness(businessId, business.id);
  ...
  findAll(@Param('businessId', ParseUUIDPipe) businessId: string, @CurrentBusiness() business: CurrentBusinessData, @Query() query: SaleQueryDto) {
    this.assertBusiness(businessId, business.id);
  ...
  findOne(@Param('businessId', ParseUUIDPipe) businessId: string, @Param('saleId', ParseUUIDPipe) saleId: string, @CurrentBusiness() business: CurrentBusinessData) {
    this.assertBusiness(businessId, business.id);
