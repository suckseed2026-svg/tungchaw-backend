...
export class PurchasePaymentsService {
  ...
  async findOne(businessId: string, purchaseId: string, paymentId: string) {
  ...
  private async findPurchaseOrThrow(businessId: string, purchaseId: string) {
  ...
  private buildSummary(totalAmount: Prisma.Decimal, totalPaid: Prisma.Decimal) {
