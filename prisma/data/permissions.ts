...
export const permissionSeedData: PermissionSeedData[] = [
  ...
  {
    code: PermissionCodes.SALE_RETURN_VIEW,
    name: 'View sale returns',
    category: 'Sales - Returns',
    description: 'View sale return records belonging to the selected business.',
  },
  {
    code: PermissionCodes.SALE_RETURN_CREATE,
    name: 'Create sale returns',
    category: 'Sales - Returns',
    description:
      'Create partial or full returns against eligible completed sales.',
  },
  {
    code: PermissionCodes.SALE_RETURN_CANCEL,
    name: 'Cancel sale returns',
    category: 'Sales - Returns',
    description:
      'Cancel eligible sale returns and reverse their inventory and credit effects.',
  },
];
